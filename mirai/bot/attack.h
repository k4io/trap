...
#define ATK_VEC_GAME      14
#define ATK_VEC_ASYN      15
#define ATK_VEC_OVH       16
#define ATK_VEC_OVH2      17
#define ATK_VEC_AWE       18
#define ATK_VEC_CIA       19
#define ATK_VEC_ICE       20
#define ATK_VEC_NFO       21
#define ATK_VEC_PACK      22
#define ATK_VEC_RUSE      23
#define ATK_VEC_SHOCK     24
#define ATK_VEC_HTVAC     25
#define ATK_VEC_STLE      26
#define ATK_VEC_RAND      27
...
void attack_method_awe(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_cia(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
...
void attack_method_ovh2(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_pack(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_ruse(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_shock(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_htvac(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_stle(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
